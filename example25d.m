...
n = 20; 
rho1 = 0.983; rho2 = 0.98; rho3 = 0.977;
...
L1 = sprintf('\x03C1=%04.3f, \x03B1=%03.2f',rho1,alpha1);
L2 = sprintf('\x03C1=%04.3f, \x03B1=%03.2f',rho2,alpha2);
L3 = sprintf('\x03C1=%04.3f, \x03B1=%03.2f',rho3,alpha3);
